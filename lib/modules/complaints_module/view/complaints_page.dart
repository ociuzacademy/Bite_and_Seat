      ...
      child: Scaffold(
        ...
        body: Consumer<ComplaintsProvider>(
          builder: (context, complaintsProvider, child) {
            return BlocListener<SubmitComplaintBloc, SubmitComplaintState>(
              listener: (context, state) {
                switch (state) {
                  case SubmitComplaintLoading _:
                    OverlayLoader.show(
                      context,
                      message: 'Submitting complaint...',
                    );
                    break;
                  case SubmitComplaintError(:final errorMessage):
                    OverlayLoader.hide();
                    CustomSnackbar.showError(context, message: errorMessage);
                    break;
                  case SubmitComplaintSuccess _:
                    OverlayLoader.hide();
