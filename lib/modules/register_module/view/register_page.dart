...
import 'package:bite_and_seat/modules/register_module/utils/register_helper.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  late final RegisterHelper registerHelper;

  @override
  void initState() {
    super.initState();
    registerHelper = RegisterHelper(context: context);
  }
        ...
        listener: (context, state) {
          switch (state) {
            ...
            case UserRegisterSuccess():
              ...
              break;
            case UserRegisterError(:final String error):
              OverlayLoader.hide();
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RegisterFormFieldLabel(context: context, text: 'Email'),
                        const SizedBox(height: 8),
                        AuthField(
                          hintText: 'Email',
                        ...
                        if (registerProvider.userType == UserType.student) ...[
                          const SizedBox(height: 15),
                          RegisterFormFieldLabel(
                            context: context,
                            text: 'Batch Name',
                        ...
                        AuthButton(
                          buttonText: 'REGISTER',
                          onSubmit: () {
                            registerHelper.userRegister(
                              data: registerProvider.getRegisterData(),
                            );
                          },
                        ),
